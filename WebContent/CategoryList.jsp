...
<!-- ##### Header Area Start ##### -->
	...
	<!-- ##### Header Area End ##### -->
	<jsp:include page="/DisplayCategoryDetails"/>
	<%
		List<Category> categoeyList = (List) request.getAttribute("CategoryData");
	List<Category> sl = (List) request.getAttribute("Subcategorydata");
	%>
	...
	<div class="breadcrumb-area">
		...
		<a href="InsertCategory.jsp" id="#btn"><button style="width:200px;" class="btn alazea-btn"><i class="fa fa-plus-circle" aria-hidden="true">   Add Categoy</i></button></a>
		</div>
	...
	<div style="padding: 50px;">
		...
		<table id="example" class="table table-striped table-bordered nowrap" style="width: 100%; padding: 10px; margin-right: 200px;">
			...
			<tbody>
				<%
					for (Category cat1 : categoeyList) {	
				%>
				<tr>
				<%cnt=cnt+1; %>
					<td><%=cnt%></td>
					<td><%=cat1.getCat_name() %></td>
			<%-- 		<td><%=cat1.getStatus() %></td>   --%>
