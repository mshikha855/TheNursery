...
<script type="text/javascript">
	...
	function getid(catid){
		...
		var cid=catid;
		var strLink="DeleteServiceDetails?id="+cid;
...
<body>
	...
	<div class="breadcrumb-area">
		...
		<a href="InsertService.jsp" id="#btn"><button style="width:200px; " class="btn alazea-btn"><i class="fa fa-plus-circle" aria-hidden="true">Add Service</i></button></a>
	...
	<div style="padding: 50px;">
		...
		<table id="example" class="table table-striped table-bordered nowrap" style="width:100%; padding: 10px; margin-right: 200px;">
			...
			<tbody>
				...
				<tr>
					<td><%=cnt%><%cnt++; %></td>
					<td><%=s.getServiceDetails() %></td>
				
					<td><%=s.getServiceAmount()%></td>
					<td><img id="pic1" height="150px" width="150px" src="data:image/png;base64,<%=s.getServiceImageString()%>"></td>
					
					<td><a type="button" href="EditServiceDetails?id=<%=s.getServiceId()%>"><i class="fa fa-edit" aria-hidden="true" style="color:green; cursor: pointer; font-size: 25px;"></i></a></td>
					
			<td>	<a type="button" data-toggle="modal" data-target="#exampleModalCenter" onclick="getid(<%=s.getServiceId()%>);"><i class="fa fa-trash" aria-hidden="true" style="color:red; cursor: pointer; font-size: 25px;"></i></a></td>
		...
		<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">Delete Service?</div>
					        ...
					        $("body").on("click", "#btnExport", function () {
					            html2canvas($('#example')[0], {
					                onrendered: function (canvas) {
					                    ...
					                    pdfMake.createPdf(docDefinition).download("ServiceList.pdf");
					                }
					            });
					        });
					    </script>
