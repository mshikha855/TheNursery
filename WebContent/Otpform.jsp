...
<body style="background-image: url('img/bg-img/back.jpg');">
    <div class="container">
        ...
        <form class="form validity" method="post" action="GetOtpServlet">
        ...
        <h1 style="font-weight:bold; font-size:50px; text-align: center; margin-bottom: 40px;">OTP</h1>
			...
			<p>CHECK YOUR EMAIL AND ENTER CORRECT OTP</p><br>
                ...
                <input type="hidden" name="originalotp" value="<%=u.getOtp() %>"> 
			...
			<p class="mt-20"><a href="Forgetpassword.jsp">Back to forgot Password</a></p>		
