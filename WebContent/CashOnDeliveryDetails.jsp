...
<body>
	...
	OrderDetails order=(OrderDetails)request.getAttribute("CashOrder");
                    ...
                    <div class="panel panel-default height">
                        ...
                        <div class="panel-body" style="padding:20px;">
                            ...
                            <%for(User user:UserList){ %>
                            	...
                            	<%l=user.getUserid(); %>
                            	<strong>User Name : </strong><%=user.getFname() %><%=user.getLname() %><br><br>
                            <%}} %>
                            <Strong>Address : </Strong><%=order.getDeliveryaddress() %><br><br>
                            <Strong>Area Name : </Strong><%=order.getDeliveryareaname() %><br>
                            <br>
                            <%int ans=os.deletecartdetails(Integer.toString(l)); %>
                        </div>
