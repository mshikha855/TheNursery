...
<body>
	...
	<%
		List<ServiceBooking> bookedservicelist=(List)request.getAttribute("BookedServiceList");
    ...
    <div class="breadcrumb-area" style="background-color: white;">
                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Booked Services</li>
                        </ol>
                    </nav>
                </div>
            </div>
       ...
       <%for(ServiceBooking sb : bookedservicelist){ %> 
       <%if(u.getUserid()==sb.getUserid()) {%>
