...
<%Category cat=(Category)request.getAttribute("categoryList");
	...
	<div class="container">
		...
		<div class="back"
			...
			<form class="form validity" action="UpdateCategoryDetailsServlet" method="post">
				
				<h1 style="font-weight: bold; font-size: 30px; text-align: center; margin-bottom: 30px;">Edit Category</h1>
				...
				<div class="form-group">
					...
					<div class="col-12 mb-4">
						...
						<input id="name2" name="categoryname" class="form-control input-group-lg reg_name" data-missing="This field is required" type="text" value="<%=cat.getCat_name() %>" required style="width: 500px;">
				...
				<div class="checkout-btn mt-30">
					...
					<a href="CategoryList.jsp" type="button" class="btn alazea-btn" style="margin-left: 20px;">Back</a>
				</div>
